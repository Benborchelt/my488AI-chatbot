...
export const CHAT_HEADER: string = `BracketBoosterAI`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Data Last Updated Wednesday March 5th, 2025 at 8:37Pm`;
export const CLEAR_BUTTON_TEXT: string = `Clear Conversation`;
export const PAGE_TITLE: string = `BracketBoosterAI`;
